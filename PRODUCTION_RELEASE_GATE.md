...
- بيان `server-assets/question-images/release-manifest.json` لا يثبت النشر
  وحده؛ يجب أن ينجح `npm run images:verify-curated-remote-assets` من شبكة
  خارجية وأن يعيد كل أصل الحجم والنوع وSHA-256 المتوقعة.
- إذا غابت الأصول من عملية الخادم، يتدهور الكتالوج إلى البنك النصي فقط ولا
  يعلن فئات صور مكسورة. مع ذلك يبقى غياب أي أصل مانعًا لإصدار التطبيق.
- ملفات الصور الثنائية لا تُضاف إلى Git. تُنقل من مخزن أصول الإصدار إلى
  مساحة نشر محمية، ثم تُفحص البصمات قبل تحويل حركة العملاء.
...
1.4 جاهز للرفع. يجب أيضاً نجاح اختبارات المشروع والبناء، وظهور
