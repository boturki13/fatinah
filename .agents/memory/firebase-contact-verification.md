...
**How to apply:** أرقام الهاتف تُرسل إلى Firebase بصيغة E.164 مثل `+9665xxxxxxxx`. يجب تفعيل Email/Password وPhone في Firebase Console، وإضافة نطاقات الويب المسموح بها قبل اختبار SMS من المتصفح.