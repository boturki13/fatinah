# Migrating web UI to فَطِنة Design System

Read `artifacts/fatinah-design-system/docs/AGENTS.md` and
`artifacts/fatinah-design-system/docs/consuming-web.md` first. Use this guide
...
- `@/components/ui/<name>` →
  `@workspace/fatinah-design-system/components/ui/<name>`
- `@/lib/utils` (`cn`) → `@workspace/fatinah-design-system/lib/utils`
- `@/hooks/use-toast` → `@workspace/fatinah-design-system/hooks/use-toast`
