# فَطِنة Design System design system
...
workspace package (`@workspace/fatinah-design-system`): other artifacts depend
...
`@workspace/fatinah-design-system/components/...`. Never use a `@/` alias inside
...
for `@workspace/fatinah-design-system` and renders mockups using this package's
theme and components.

## Consuming this package

Never copy token values, component source, hooks, or these docs into a consuming
artifact. Add `@workspace/fatinah-design-system` as a `workspace:*` dependency,
run `pnpm install`, and import directly from this package.

Read only the guides required by the current task:

- Building or styling web UI: `artifacts/fatinah-design-system/docs/consuming-web.md`
- Building or styling Expo UI: `artifacts/fatinah-design-system/docs/consuming-expo.md`
- Replacing an existing or scaffolded web theme/component library:
  `artifacts/fatinah-design-system/docs/migrating-web.md`
- Replacing existing or scaffolded Expo theme/hooks/components:
  `artifacts/fatinah-design-system/docs/migrating-expo.md`
