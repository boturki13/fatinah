# Migrating Expo UI to فَطِنة Design System

Read `artifacts/fatinah-design-system/docs/AGENTS.md` and
`artifacts/fatinah-design-system/docs/consuming-expo.md` first. Use this guide
...
- Rewrite color/theme imports to
  `@workspace/fatinah-design-system/lib/native-theme` and
  `@workspace/fatinah-design-system/hooks/use-colors`.
- Rewrite the root layout to use
  `@workspace/fatinah-design-system/hooks/use-fonts` while preserving its
  SplashScreen gating.
...
and hook directly from `@workspace/fatinah-design-system` and retains only
