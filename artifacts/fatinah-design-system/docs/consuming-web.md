# Consuming فَطِنة Design System in web apps

Read `artifacts/fatinah-design-system/docs/AGENTS.md` first. This guide covers
...
`artifacts/fatinah-design-system/docs/migrating-web.md` before writing UI.
...
```css
@import "@workspace/fatinah-design-system/styles.css";
```
...
`node_modules/@workspace/fatinah-design-system/src/components` to `content`.
...
```tsx
import { Button } from "@workspace/fatinah-design-system/components/ui/button";
import { cn } from "@workspace/fatinah-design-system/lib/utils";
import {
  toast,
  useToast,
} from "@workspace/fatinah-design-system/hooks/use-toast";
```
...
`@workspace/fatinah-design-system/components/ui/button`. Run the app's typecheck
