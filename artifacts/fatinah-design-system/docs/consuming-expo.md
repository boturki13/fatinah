# Consuming فَطِنة Design System in Expo apps

Read `artifacts/fatinah-design-system/docs/AGENTS.md` first. React Native does
...
`artifacts/fatinah-design-system/docs/migrating-expo.md` before writing UI.
...
```tsx
import { tokens } from "@workspace/fatinah-design-system/tokens";
...
```tsx
import { nativeTheme } from "@workspace/fatinah-design-system/lib/native-theme";
import { useColors } from "@workspace/fatinah-design-system/hooks/use-colors";
import { useDesignSystemFonts } from "@workspace/fatinah-design-system/hooks/use-fonts";
```
...
```tsx
import { Badge } from "@workspace/fatinah-design-system/components/native/badge";
import { Button } from "@workspace/fatinah-design-system/components/native/button";
import { Card } from "@workspace/fatinah-design-system/components/native/card";
```
...
Import and render
`@workspace/fatinah-design-system/components/native/button`, then run Expo
