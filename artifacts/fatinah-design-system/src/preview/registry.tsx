...
export const DESIGN_SYSTEM = {
  title: 'فَطِنة Design System',
  description:
    'نظام بصري عربي للعبة فَطِنة الجماعية: ثيم داكن عميق، تدرّج ناري، وبطاقات زجاجية مصممة للمجالس والعائلات.',
} as const;
    ...
    entries: [
      {
        id: 'brand-language',
        name: 'لغة فَطِنة',
        description: 'الهوية البصرية، التدرّج الناري، وألوان اللعب.',
        Page: BrandPage,
      },
    ],
  },
